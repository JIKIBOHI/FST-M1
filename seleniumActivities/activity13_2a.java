...
public class activity13_2a {
	...
	public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1", "Jiki", "Bohidar", "jiki@test.com", "9876543210"};
        String[] row2 = {"2", "Jiku", "Bohidar", "jiku@test.com", "8765432109"};
        String[] row3 = {"3", "Dev", "Bohidar", "dev@test.com", "7654321098"};
